...
public class RegExSearchTest {
    ...
    public void searchIgnoreCase() {
        String str = "Осень пришла.";
        String word = "осень";
        RegExSearch searchEngine = new RegExSearch();
        Assertions.assertEquals(1, searchEngine.searchIgnoreCase(str, word));
    }

    @Test
    public void searchIgnoreCase2() {
        String str = "Осень пришла. Здравствуй, Осень.";
        String word = "осень";
        RegExSearch searchEngine = new RegExSearch();
        Assertions.assertEquals(2, searchEngine.searchIgnoreCase(str, word));
    }

    @Test
    public void searchIgnoreCase3() {
        String str = "Осень пришла, и Здравствуй. Осень, и осень ушла.";
        String word = "осень";
        RegExSearch searchEngine = new RegExSearch();
        Assertions.assertEquals(3, searchEngine.searchIgnoreCase(str, word));
    }
}
